...
import jet.opengl.renderer.Unreal4.UE4LightCollections;
import jet.opengl.renderer.Unreal4.UE4LightInfo;

public class VolumetricFog implements Disposeable {
...
//                FProjectedShadowInfo* ProjectedShadowInfo = GetShadowForInjectionIntoVolumetricFog(LightSceneInfo->Proxy, VisibleLightInfos[LightSceneInfo->Id]);
				...
				final BoundingSphere LightBounds = LightSceneInfo.boundingSphere;
...
//        throw new UnsupportedOperationException();
    ...
    private Vector3i CalculateVolumetricFogBoundsForLight(BoundingSphere LightBounds, Matrix4f View, Vector3i VolumetricFogGridSize, ReadableVector3f GridZParams) {
