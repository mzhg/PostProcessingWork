...
import jet.opengl.renderer.Unreal4.FMeshElementCollector;
...
public abstract class FPrimitiveSceneProxy implements Disposeable {
    /** Initialization constructor. */
    public FPrimitiveSceneProxy(UPrimitiveComponent InComponent, String ResourceName){
...
//    ENGINE_API virtual SIZE_T GetTypeHash() const = 0;
     ...
     */
    public void SetSelection_GameThread(boolean bInParentSelected, boolean bInIndividuallySelected/*=false*/){
        throw new UnsupportedOperationException();
    }
     ...
     */
    public void SetHovered_GameThread(boolean bInHovered){
        throw new UnsupportedOperationException();
    }
     ...
     */
    public void SetHiddenEdViews_GameThread( long InHiddenEditorViews ){
        throw new UnsupportedOperationException();
    }

    /** @return True if the primitive is visible in the given View. */
    public boolean IsShown(FSceneView View){
        throw new UnsupportedOperationException();
    }

    /** @return True if the primitive is casting a shadow. */
    public boolean IsShadowCast(FSceneView View) {
        throw new UnsupportedOperationException();
    }

    /** Helper for components that want to render bounds. */
    public void RenderBounds(FPrimitiveDrawInterface* PDI, FEngineShowFlags EngineShowFlags, FBoxSphereBounds Bounds, boolean bRenderInEditor){
        throw new UnsupportedOperationException();
    }

    /** Verifies that a material used for rendering was present in the component's GetUsedMaterials list. */
    public void VerifyUsedMaterial(const class FMaterialRenderProxy* MaterialRenderProxy) {
        throw new UnsupportedOperationException();
    }

    /** Returns the LOD that the primitive will render at for this view. */
    public int GetLOD(FSceneView View)  { return UE4Engine.INDEX_NONE; }
     ...
     */
    public HHitProxy CreateHitProxies(UPrimitiveComponent Component,TArray<TRefCountPtr<HHitProxy> >& OutHitProxies){
        throw new UnsupportedOperationException();
    }
...
//#if WITH_EDITOR
     ...
     */
    public FColorVertexBuffer* GetCustomHitProxyIdBuffer() { return null; }
//#endif
    /**
     ...
     */
    public void DrawStaticElements(FStaticPrimitiveDrawInterface PDI) {}

    /** Gathers a description of the mesh elements to be rendered for the given LOD index, without consideration for views. */
    public void GetMeshDescription(int LODIndex, ArrayList<FMeshBatch> OutMeshElements) {}

    /** Gathers shadow shapes from this proxy. */
    public void GetShadowShapes(TArray<FCapsuleShape> CapsuleShapes) {}

//#if RHI_RAYTRACING
    public boolean IsRayTracingRelevant() { return false; }
    public boolean IsRayTracingStaticRelevant() { return false; }
...
//#endif // RHI_RAYTRACING
    ...
    public int CollectOccluderElements(FOccluderElementsCollector Collector)  { return 0; }
     ...
     */
    public void GetDynamicMeshElements(ArrayList<FSceneView> Views, FSceneViewFamily ViewFamily, int VisibilityMap, FMeshElementCollector Collector) {}
     ...
     */
    public TArray<FBoxSphereBounds> GetOcclusionQueries( FSceneView View)
    {
        return null;
    }
     ...
     */
    public void AcceptOcclusionResults(FSceneView View, StackBool Results, int ResultsStart, int NumResults) {}
     ...
     */
    public FPrimitiveViewRelevance GetViewRelevance(FSceneView View){
        throw new UnsupportedOperationException();
    }

    /** Callback from the renderer to gather simple lights that this proxy wants renderered. */
    public void GatherSimpleLights(FSceneViewFamily ViewFamily, FSimpleLightArray OutParticleLights) {}
     ...
     */
    public long GetLightRelevance(FLightSceneProxy LightSceneProxy/*, bool& bDynamic, bool& bRelevant, bool& bLightMapped, bool& bShadowMapped*/)
    {
        final short TRUE = 1;
        final short FALSE = 0;
        ...
        short bDynamic = TRUE;
        short bRelevant = TRUE;
        short bLightMapped = FALSE;
        short bShadowMapped = FALSE;

        int first = Numeric.encode(bDynamic, bRelevant);
        int second = Numeric.encode(bLightMapped, bShadowMapped);

        return Numeric.encode(first, second);
    }

    /*public void GetDistancefieldAtlasData(FBox LocalVolumeBounds, Vector2f OutDistanceMinMax, FIntVector& OutBlockMin, FIntVector& OutBlockSize, bool& bOutBuiltAsIfTwoSided, bool& bMeshWasPlane, float& SelfShadowBias, TArray<FMatrix>& ObjectLocalToWorldTransforms, bool& bOutThrottled) const
    {
    ...
    public long GetDistanceFieldInstanceInfo(/*int32& NumInstances, float& BoundsSurfaceArea*/)
    {
        int NumInstances = 0;
    ...
    public boolean HeightfieldHasPendingStreaming() { return false; }

    public void GetHeightfieldRepresentation(UTexture2D*& OutHeightmapTexture, UTexture2D*& OutDiffuseColorTexture, UTexture2D*& OutVisibilityTexture, FHeightfieldComponentDescription& OutDescription)
    {
     ...
     *	Called in the rendering thread.
     */
    public void CreateRenderThreadResources() {}
     ...
     */
    public void OnDetachLight(FLightSceneInfo Light) { }
     ...
     */
    public void OnLevelAddedToWorld() {}
     ...
     */
    public boolean IsUsingDistanceCullFade()
    {
        return false;
    }
     ...
     */
    public boolean HasSubprimitiveOcclusionQueries()
    {
        return false;
    }

    public boolean ShowInBSPSplitViewmode()
    {
        return false;
    }
     ...
     */
    public int GetStaticDepthPriorityGroup()
    {
        UE4Engine.check(!HasViewDependentDPG());
     ...
     */
    public int GetDepthPriorityGroup(FSceneView View)
    {
    ...
    public abstract int GetMemoryFootprint(  );
    public int GetAllocatedSize(  )  { return( Owners.GetAllocatedSize() ); }

    /**
     * Set the collision flag on the scene proxy to enable/disable collision drawing
     *
     * @param bNewEnabled new state for collision drawing
     */
    public void SetCollisionEnabled_GameThread(boolean bNewEnabled){
        throw new UnsupportedOperationException();
    }
     ...
     * @param bNewEnabled new state for collision drawing
     */
    public void SetCollisionEnabled_RenderThread(boolean bNewEnabled){
        throw new UnsupportedOperationException();
}
     ...
     *
     * @param bInRenderCustomDepth
     */
    public void SetCustomDepthEnabled_GameThread(boolean bInRenderCustomDepth){
        throw new UnsupportedOperationException();
                }
     ...
     *
     * @param bInRenderCustomDepth the new value
     */
    public void SetCustomDepthEnabled_RenderThread(boolean bInRenderCustomDepth){
        throw new UnsupportedOperationException();
    }
     ...
     *
     * @param InCustomDepthStencilValue the new value
     */
    public void SetCustomDepthStencilValue_GameThread(int InCustomDepthStencilValue ){
        throw new UnsupportedOperationException();
    }
    ...
    // Accessors.
    public FSceneInterface GetScene() { return Scene; }
     ...
     */
    public boolean IsDetailMesh() const
    {
        return false;
    }
     ...
     */
    public boolean HasCustomOcclusionBounds() const
    {
        return false;
    }
    ...
    public boolean HasDistanceFieldRepresentation() const
    {
        return false;
    }

    public boolean HasDynamicIndirectShadowCasterRepresentation() const
    {
        return false;
    }
     ...
     */
    public boolean GetPrimitiveDistance(int32 LODIndex, int32 SectionIndex, const FVector& ViewOrigin, float& PrimitiveDistance) const;
     ...
     */
    public boolean GetMeshUVDensities(int32 LODIndex, int32 SectionIndex, FVector4& WorldUVDensities) const;
     ...
     */
    public boolean GetMaterialTextureScales(int32 LODIndex, int32 SectionIndex, const class FMaterialRenderProxy* MaterialRenderProxy, FVector4* OneOverScales, struct FIntVector4* UVChannelIndices) const;
#endif
    ...
    ENGINE_API public boolean IsDrawnInGame() const { return DrawInGame; }

    /** Tell us if we should rely on the default LOD computing rules or not.*/
    ENGINE_API public boolean IsUsingCustomLODRules() const { return false; }
    ...
    ENGINE_API public boolean IsUsingCustomWholeSceneShadowLODRules() const { return false; }
