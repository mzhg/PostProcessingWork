...
public class PostProcessingGaussionBlurProgram2 extends GLSLProgram {

    static final float[] std_weights = {0.42f,0.25f,0.15f,0.10f};

    public PostProcessingGaussionBlurProgram2(int img_width, int img_height, boolean vertical, float weight) throws IOException {
