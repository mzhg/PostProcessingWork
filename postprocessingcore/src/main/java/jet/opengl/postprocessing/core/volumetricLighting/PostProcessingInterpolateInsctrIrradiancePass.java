...
final class PostProcessingInterpolateInsctrIrradiancePass extends PostProcessingRenderPass{
    ...
    private VolumetricLightingProgram m_InterpolateIrradianceProgram = null;
...
//        m_ptex2DInterpolationSourcesSRV.bind(RenderTechnique.TEX2D_INTERP_SOURCE, m_psamLinearClamp);
        ...
        context.bindTexture(ptex2DInitialScatteredLightSRV, VolumetricLightingProgram.TEX2D_INIT_INSCTR, m_sharedData.m_psamLinearClamp);
        context.bindTexture(ptex2DInterpolationSourcesSRV, VolumetricLightingProgram.TEX2D_INTERP_SOURCE, m_sharedData.m_psamLinearClamp);
