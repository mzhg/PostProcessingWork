...
final class PostProcessingMarkRayMarchingSamplesPass extends PostProcessingRenderPass{
    ...
    private VolumetricLightingProgram m_MarkRayMarchingSamplesInStencilProgram = null;
    ...
    public void process(PostProcessingRenderContext context, PostProcessingParameters parameters) {
        ...
        context.bindTexture(input, VolumetricLightingProgram.TEX2D_INTERP_SOURCE, m_sharedData.m_psamLinearClamp);
