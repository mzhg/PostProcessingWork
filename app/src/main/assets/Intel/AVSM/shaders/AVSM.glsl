...
void StoreDataRep(inout AVSMData data, in vec4 depth[AVSM_RT_COUNT + 1], in vec4 trans[AVSM_RT_COUNT + 1])
{
                       ...
                       inout AVSMData avsmData)
{
    ...
    vec4 newDepth[AVSM_RT_COUNT + 1];
    vec4 newTrans[AVSM_RT_COUNT + 1];
...
Texture2DArray<float4>  gDebugAVSMDataSRV           : register(t27);
