...
void main()
{
    vec4 v0 = g_ViewProj * vec4(m_WorldPos[0], 1);  v0 /= v0.w;
    vec4 v1 = g_ViewProj * vec4(m_WorldPos[1], 1);  v1 /= v1.w;
    vec4 v2 = g_ViewProj * vec4(m_WorldPos[2], 1);  v2 /= v2.w;
    ...
    if (maxZ >= 0)
    {
        ...
        GenerateOmniTriangle(1, v2, v1, v0);
    }
    ...
    if (minZ <= 0)
    {
        ...
        v1.z *= -1.0;
        v2.z *= -1.0;
        GenerateOmniTriangle(0, v0, v1, v2);
    }
}