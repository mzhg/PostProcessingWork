...
void main()
{
    ...
    float4 LightPositionViewSpace = mul( float4(g_PointLightBufferCenterAndRadius[gl_InstanceID].xyz,1), g_mView );
    ...
    _output.Color = g_PointLightBufferColor[Input.InstanceID].rgb;
    _output.TextureUV = Input.TextureUV;
}