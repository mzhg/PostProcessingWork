...
void main()
{
    ...
    m_TexCoord1 = (m_f4UVAndScreenPos.xy - 0.5) * g_Scalar[0] + 0.5;
    m_TexCoord2 = (m_f4UVAndScreenPos.xy - 0.5) * g_Scalar[1] + 0.5;
    m_TexCoord3 = (m_f4UVAndScreenPos.xy - 0.5) * g_Scalar[2] + 0.5;
    m_TexCoord4 = (m_f4UVAndScreenPos.xy - 0.5) * g_Scalar[3] + 0.5;
