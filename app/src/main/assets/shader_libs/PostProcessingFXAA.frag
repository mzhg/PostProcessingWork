...
in vec4 m_f4FXAA_ConsolePosPos;
...
void main()
{
//	Color = vec4(0.5) + texture(texToSample,In.Texcoord);

	Out_f4Color = FxaaPixelShader(
		/*FxaaFloat2 pos*/							m_f4UVAndScreenPos.xy,
		/*FxaaFloat4 fxaaConsolePosPos*/			m_f4FXAA_ConsolePosPos,
		/*FxaaTex tex*/								g_Texture,
		/*FxaaTex fxaaConsole360TexExpBiasNegOne*/	g_Texture,
		/*FxaaTex fxaaConsole360TexExpBiasNegTwo*/	g_Texture,
		/*FxaaFloat2 fxaaQualityRcpFrame*/			g_f2FrameRcpFrame,
		/*FxaaFloat4 fxaaConsoleRcpFrameOpt*/		vec4(-0.5, -0.5, 0.3, 0.3)*g_f2FrameRcpFrame.xyxy,
		/*FxaaFloat4 fxaaConsoleRcpFrameOpt2*/		vec4(-2.0, -2.0, 2.0, 2.0)*g_f2FrameRcpFrame.xyxy,
		/*FxaaFloat4 fxaaConsole360RcpFrameOpt2*/	vec4(8.0, 8.0, -4.0, -4.0)*g_f2FrameRcpFrame.xyxy,
