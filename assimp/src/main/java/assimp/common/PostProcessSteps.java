 ...
 *
 *  Some steps are influenced by properties set on the {@link Importer} itself
 *
 ...
 *  @see ImportFileEx
 */
public interface PostProcessSteps {

	// -------------------------------------------------------------------------
	/** <hr>Calculates the tangents and bitangents for the imported meshes. <p>
	 *
	...
	// -------------------------------------------------------------------------
	/** <hr>Converts all the imported data to a left-handed coordinate space. <p>
	 *
	...
	// -------------------------------------------------------------------------
	/** <hr>Triangulates all faces of all meshes. <p>
	 *
	 ...
	 * step you can make sure they are NOT there.<p>
	 *
	...
	// -------------------------------------------------------------------------
	/** <hr>Generates normals for all faces of all meshes. <p>
	 *
	 ...
	 * #aiProcess_JoinIdenticalVertices is *senseless* then.<p>
	 *
	...
	// -------------------------------------------------------------------------
	/** <hr>Generates smooth normals for all vertices in the mesh.<p>
	*
	* This is ignored if normals are already there at the time this flag 
	* is evaluated. Model importers try to load them from the source file, so
	...
	*/
	...
	// -------------------------------------------------------------------------
	/** <hr>Splits large meshes into smaller sub-meshes.<p>
	*
	...
	* Animations are removed during this step.<p>
	* This step is intended for applications without a scenegraph.
	* The step CAN cause some problems: if e.g. a mesh of the asset
	* contains normals and another, using the same material index, does not, 
	* they will be brought together, but the first meshes's part of
	* the normal list is zeroed. However, these artifacts are rare.
	* <p><b>NOTE: </b> The <tt>#AI_CONFIG_PP_PTV_NORMALIZE</tt> configuration property
	...
	* property to supply your own limit to the post processing step.<p>
	*
	...
	*/
	...
	// -------------------------------------------------------------------------
	/** <hr>Reorders triangles for better vertex cache locality.<p>
	 *
	...
	// -------------------------------------------------------------------------
	/** <hr>Searches for redundant/unreferenced materials and removes them.<p>
	 *
	...
	*/
	 ...
	 *       <pre> aiPrimitiveType_POINTS | aiPrimitiveType_LINES
	 *       </pre> to cause SortByPType to reject point
	 *       and line meshes from the scene.
	 *   </li>
	 * </ul>
	 * <p><b>NOTE: </b> Degenerate polygons are not necessarily evil and that's why
	...
	*/
	 ...
	 * LightWave, and Modo do this for example.<p>
	 *
	 * <p><b>NOTE: </b> If this step is not requested, you'll need to process the
     ...
     *
	 * <p><b>NOTE: </b> UV transformations are usually implemented in real-time apps by 
	...
	*/
	...
	// -------------------------------------------------------------------------
	/** <hr>A postprocessing step to reduce the number of meshes.<p>
	 *
	...
	*/
	 ...
	 *  results.
	 *
	 *  <p><b>NOTE: </b> 'Crappy' scenes with thousands of extremely small meshes packed
	...
	*/
	...
	// -------------------------------------------------------------------------
	/** <hr>This step adjusts the output face winding order to be CW.<p>
	 *
    ...
    */
	...
	// -------------------------------------------------------------------------
	/** <hr>This step removes bones losslessly or according to some threshold.<p>
	 *
    ...
    */
	...
	// ---------------------------------------------------------------------------------------
	/** 
	 *  Shortcut flag for Direct3D-based applications. <p>
	 *
	...
	// ---------------------------------------------------------------------------------------
	/** 
	 *  Default postprocess configuration optimizing the data for real-time rendering.<p>
	 *  
	 *  Applications would want to use this preset to load models on end-user PCs,
	 *  maybe for direct use in game.<p>
	 *
	 * If you're using DirectX, don't forget to combine this value with
	 * the #aiProcess_ConvertToLeftHanded step. If you don't support UV transformations
	 * in your application apply the #aiProcess_TransformUVCoords step, too.
	 *  <p><b>NOTE: </b> Please take the time to read the docs for the steps enabled by this preset. 
	...
	public static final int aiProcessPreset_TargetRealtime_Fast =
	  ...
	  *  environment where import speed is not so important.<p>
	  *  
	  *  If you're using DirectX, don't forget to combine this value with
	  *  the #aiProcess_ConvertToLeftHanded step. If you don't support UV transformations
	  *  in your application apply the #aiProcess_TransformUVCoords step, too.
