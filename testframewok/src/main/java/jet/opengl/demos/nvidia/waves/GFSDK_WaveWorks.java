...
// This can be used to conservatively inflate camera frusta for culling purposes (e.g. as a suitable value for Quadtree_SetFrustumCullMargin)
    public static float GFSDK_WaveWorks_Simulation_GetConservativeMaxDisplacementEstimate(GFSDK_WaveWorks_Simulation hSim){
        return hSim.getConservativeMaxDisplacementEstimate();
    }

    private static GFSDK_WaveWorks_Result Simulation_Kick_Generic(GFSDK_WaveWorks_Simulation hSim, long[] pKickID, /*Graphics_Context* pGC,*/ GFSDK_WaveWorks_Savestate hSavestate)
    {
...
//        }
        ...
        return ToAPIResult(hSim.kick(pKickID, /*pGC, */hSavestate));
    }
...
// is already completely full, this means waiting for an in-flight kick to exit the CPU pipeline (kicks are processed in FIFO order)
    public static GFSDK_WaveWorks_Result GFSDK_WaveWorks_Simulation_KickNoGraphics(GFSDK_WaveWorks_Simulation hSim, long[] pKickID){
        if(g_InitialisedAPI != nv_water_d3d_api.nv_water_d3d_api_none) {
            LogUtil.e(LogUtil.LogType.DEFAULT, "ERROR: 'GFSDK_WaveWorks_Simulation_KickNoGraphics' was called but the library was not initialised for none!");
            return GFSDK_WaveWorks_Result.FAIL;
        }

        return Simulation_Kick_Generic(hSim, pKickID, null);
    }
    public static GFSDK_WaveWorks_Result GFSDK_WaveWorks_Simulation_KickD3D11(GFSDK_WaveWorks_Simulation hSim, long[] pKickID,  GFSDK_WaveWorks_Savestate hSavestate){
        if(g_InitialisedAPI != nv_water_d3d_api.nv_water_d3d_api_d3d11) {
            LogUtil.e(LogUtil.LogType.DEFAULT, "ERROR: 'GFSDK_WaveWorks_Simulation_KickD3D11' was called but the library was not initialised for d3d11!");
            return GFSDK_WaveWorks_Result.FAIL;
        }
    ...
    public static GFSDK_WaveWorks_Result GFSDK_WaveWorks_Simulation_KickGL2(GFSDK_WaveWorks_Simulation hSim, long[] pKickID){
        if(g_InitialisedAPI != nv_water_d3d_api.nv_water_d3d_api_gl2) {
            LogUtil.e(LogUtil.LogType.DEFAULT, "ERROR: 'GFSDK_WaveWorks_Simulation_KickGL2' was called but the library was not initialised for gl2!");
            return GFSDK_WaveWorks_Result.FAIL;
        }
...
// The staging cursor will only ever change during an API call, and is guaranteed to advance by a maximum of one kick in any one call
    public static GFSDK_WaveWorks_Result GFSDK_WaveWorks_Simulation_GetStagingCursor(GFSDK_WaveWorks_Simulation hSim, long[] pKickID){
        if(hSim.getStagingCursor(pKickID)){
            return GFSDK_WaveWorks_Result.OK;
        }else{
            return GFSDK_WaveWorks_Result.NONE;
        }
    }

    // Advances the staging cursor

    private static GFSDK_WaveWorks_Result Simulation_AdvanceStagingCursor_Generic(GFSDK_WaveWorks_Simulation hSim, boolean block, /*Graphics_Context* pGC,*/ GFSDK_WaveWorks_Savestate hSavestate)
    {
        GFSDK_WaveWorks_Savestate pImpl = hSavestate;
//        if(hSavestate)
//        {
...
//        }
        ...
        boolean[] wouldBlock = new boolean[1];
        HRESULT hr = hSim.advanceStagingCursor(block,wouldBlock,pImpl);
        if(HRESULT.S_OK == hr)
        {
        ...
        else if(HRESULT.S_FALSE == hr)
        {
            ...
            {
                // Would have blocked
                return GFSDK_WaveWorks_Result.WOULD_BLOCK;
            }
            else
            {
...
// Returns gfsdk_waveworks_result_WOULD_BLOCK if there are in-flight kicks in the CPU part of the pipeline, but they're not ready for staging
    public static GFSDK_WaveWorks_Result GFSDK_WaveWorks_Simulation_AdvanceStagingCursorNoGraphics(GFSDK_WaveWorks_Simulation hSim, boolean block){
        if(g_InitialisedAPI != nv_water_d3d_api.nv_water_d3d_api_none) {
            LogUtil.e(LogUtil.LogType.DEFAULT, "ERROR: 'GFSDK_WaveWorks_Simulation_AdvanceStagingCursorNoGraphics' was called but the library was not initialised for none!");
            return GFSDK_WaveWorks_Result.FAIL;
        }

        return Simulation_AdvanceStagingCursor_Generic(hSim, block, null);
    }

    public static GFSDK_WaveWorks_Result GFSDK_WaveWorks_Simulation_AdvanceStagingCursorD3D11(GFSDK_WaveWorks_Simulation hSim, boolean block, /*ID3D11DeviceContext* pDC,*/ GFSDK_WaveWorks_Savestate hSavestate){
        if(g_InitialisedAPI != nv_water_d3d_api.nv_water_d3d_api_d3d11) {
            LogUtil.e(LogUtil.LogType.DEFAULT, "ERROR: 'GFSDK_WaveWorks_Simulation_AdvanceStagingCursorD3D11' was called but the library was not initialised for d3d11!");
            return GFSDK_WaveWorks_Result.FAIL;
        }

        return Simulation_AdvanceStagingCursor_Generic(hSim, block, hSavestate);
    }

    public static GFSDK_WaveWorks_Result GFSDK_WaveWorks_Simulation_AdvanceStagingCursorGL2(GFSDK_WaveWorks_Simulation hSim, boolean block){
        if(g_InitialisedAPI != nv_water_d3d_api.nv_water_d3d_api_gl2) {
            LogUtil.e(LogUtil.LogType.DEFAULT, "ERROR: 'GFSDK_WaveWorks_Simulation_KickGL2' was called but the library was not initialised for gl2!");
            return GFSDK_WaveWorks_Result.FAIL;
        }
...
// Returns gfsdk_waveworks_result_NONE if there are no in-flight kicks in the CPU part of the simulation pipeline
    public static GFSDK_WaveWorks_Result GFSDK_WaveWorks_Simulation_WaitStagingCursor(GFSDK_WaveWorks_Simulation hSim){
        return ToAPIResult(hSim.waitStagingCursor());
    }
...
// The readback cursor will only ever change during an API call, and is guaranteed to advance by a maximum of one kick in any one call
    public static GFSDK_WaveWorks_Result GFSDK_WaveWorks_Simulation_GetReadbackCursor(GFSDK_WaveWorks_Simulation hSim, long[] pKickID){
        if(hSim.getReadbackCursor(pKickID)){
...
// Returns gfsdk_waveworks_result_WOULD_BLOCK if there are readbacks in-flight  beyond staging, but they're not yet ready
    public static GFSDK_WaveWorks_Result GFSDK_WaveWorks_Simulation_AdvanceReadbackCursor(GFSDK_WaveWorks_Simulation hSim, boolean block){
        boolean[] wouldBlock = new boolean[1];
        HRESULT hr = hSim.advanceReadbackCursor(block,wouldBlock);
        if(HRESULT.S_OK == hr)
        {
            // The staging cursor points to a new set of kick results
            return GFSDK_WaveWorks_Result.OK;
...
// Returns gfsdk_waveworks_result_FAIL if no results are available for readback
    public static GFSDK_WaveWorks_Result GFSDK_WaveWorks_Simulation_ArchiveDisplacements(GFSDK_WaveWorks_Simulation hSim){
        return ToAPIResult(hSim.archiveDisplacements());
    }
...
//
    ...
    public static GFSDK_WaveWorks_Quadtree GFSDK_WaveWorks_Quadtree_CreateD3D11(GFSDK_WaveWorks_Quadtree_Params params /*ID3D11Device* pD3DDevice,*/ ){
        if(g_InitialisedAPI != nv_water_d3d_api.nv_water_d3d_api_d3d11) {
            LogUtil.e(LogUtil.LogType.DEFAULT, "ERROR: 'GFSDK_WaveWorks_Quadtree_CreateD3D11' was called but the library was not initialised for d3d11!");
            return null;
        }

        GFSDK_WaveWorks_Quadtree pImpl = new GFSDK_WaveWorks_Quadtree();
        HRESULT hr = pImpl.initD3D11(params);
        if(hr != HRESULT.S_OK)
        {
//            delete pImpl;
//            return ToAPIResult(hr);
...
//        return gfsdk_waveworks_result_OK;
    ...
    public static GFSDK_WaveWorks_Quadtree GFSDK_WaveWorks_Quadtree_CreateGL2(GFSDK_WaveWorks_Quadtree_Params params, int Program/*, GFSDK_WaveWorks_QuadtreeHandle* pResult*/){
        if(g_InitialisedAPI != nv_water_d3d_api.nv_water_d3d_api_gl2) {
            LogUtil.e(LogUtil.LogType.DEFAULT, "ERROR: 'GFSDK_WaveWorks_Quadtree_CreateGL2' was called but the library was not initialised for gl2!");
            return null;
        }
...
//        return gfsdk_waveworks_result_OK;
    ...
    public static GFSDK_WaveWorks_Result GFSDK_WaveWorks_Quadtree_Destroy(GFSDK_WaveWorks_Quadtree hQuadtree){
        hQuadtree.dispose();
        return GFSDK_WaveWorks_Result.OK;
    }
    ...
    public static GFSDK_WaveWorks_Result GFSDK_WaveWorks_Quadtree_UpdateParams(GFSDK_WaveWorks_Quadtree hQuadtree, GFSDK_WaveWorks_Quadtree_Params params){
        return ToAPIResult(hQuadtree.reinit(params));
    }

    // Retrieve information about the WaveWorks shader inputs for a given platform. This information can be used to
// query compiled shaders via a reflection interface to obtain register or constant buffer indices for subsequent
// calls to Draw
    public static int GFSDK_WaveWorks_Quadtree_GetShaderInputCountD3D11(){
        return GFSDK_WaveWorks_Quadtree.getShaderInputCountD3D11();
    }
    public static GFSDK_WaveWorks_Result GFSDK_WaveWorks_Quadtree_GetShaderInputDescD3D11(int inputIndex, GFSDK_WaveWorks_ShaderInput_Desc pDesc){
        return ToAPIResult(GFSDK_WaveWorks_Quadtree.getShaderInputDescD3D11(inputIndex, pDesc));
    }

    public static int GFSDK_WaveWorks_Quadtree_GetShaderInputCountGL2(){
        return GFSDK_WaveWorks_Quadtree.getShaderInputCountGL2();
    }
    public static GFSDK_WaveWorks_Result GFSDK_WaveWorks_Quadtree_GetShaderInputDescGL2(int inputIndex, GFSDK_WaveWorks_ShaderInput_Desc pDesc){
...
// Otherwise, WaveWorks starts frustum culling from the list of patches implied by calls to AllocPatch/FreePatch
    public static GFSDK_WaveWorks_Result GFSDK_WaveWorks_Quadtree_AllocPatch(GFSDK_WaveWorks_Quadtree hQuadtree, int x, int y, int lod, boolean enabled){
        return ToAPIResult(hQuadtree.allocPatch(x, y, lod, enabled));
    }

    public static GFSDK_WaveWorks_Result GFSDK_WaveWorks_Quadtree_FreePatch(GFSDK_WaveWorks_Quadtree hQuadtree, int x, int y, int lod){
        return ToAPIResult(hQuadtree.freePatch(x, y, lod));
    }

    private static GFSDK_WaveWorks_Result Quadtree_Draw_Generic(GFSDK_WaveWorks_Quadtree hQuadtree, Matrix4f matView, Matrix4f matProj, Vector2f pViewportDims, int[] pShaderInputRegisterMappings, GFSDK_WaveWorks_Savestate hSavestate)
    {
...
//        }
        ...
        HRESULT hr;
        GFSDK_WaveWorks_Quadtree pImpl = hQuadtree;
        hr = pImpl.buildRenderList(matView, matProj, pViewportDims);  if(hr != HRESULT.S_OK) return ToAPIResult(hr);
        hr = pImpl.flushRenderList(pShaderInputRegisterMappings, hSavestate); if(hr != HRESULT.S_OK) return ToAPIResult(hr);

        return GFSDK_WaveWorks_Result.OK;
    }

    // Draw the water surface using the specified quadtree with the specified view and projection matrices
    public static GFSDK_WaveWorks_Result GFSDK_WaveWorks_Quadtree_DrawD3D11(GFSDK_WaveWorks_Quadtree hQuadtree, Matrix4f matView, Matrix4f matProj, int[] pShaderInputRegisterMappings, GFSDK_WaveWorks_Savestate hSavestate){
        if(g_InitialisedAPI != nv_water_d3d_api.nv_water_d3d_api_d3d11) {
            LogUtil.e(LogUtil.LogType.DEFAULT, "ERROR: 'GFSDK_WaveWorks_Quadtree_DrawD3D11' was called but the library was not initialised for d3d11!");
            return GFSDK_WaveWorks_Result.FAIL;
        }

        return Quadtree_Draw_Generic(hQuadtree,matView,matProj,null,pShaderInputRegisterMappings,hSavestate);
    }

    public static GFSDK_WaveWorks_Result GFSDK_WaveWorks_Quadtree_DrawGL2(GFSDK_WaveWorks_Quadtree hQuadtree, Matrix4f matView, Matrix4f matProj, int[] pShaderInputRegisterMappings){
        if(g_InitialisedAPI != nv_water_d3d_api.nv_water_d3d_api_gl2) {
            LogUtil.e(LogUtil.LogType.DEFAULT, "ERROR: 'GFSDK_WaveWorks_Quadtree_DrawGL2' was called but the library was not initialised for gl2!");
            return GFSDK_WaveWorks_Result.FAIL;
        }

        return Quadtree_Draw_Generic(hQuadtree,matView,matProj,null,pShaderInputRegisterMappings,null);
    }
