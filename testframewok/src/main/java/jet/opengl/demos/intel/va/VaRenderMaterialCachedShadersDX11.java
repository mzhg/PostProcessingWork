...
public class VaRenderMaterialCachedShadersDX11 {
    ...
    public VaDirectXVertexShader                   VS_PosOnly;
    public VaDirectXPixelShader                    PS_DepthOnly;
    public VaDirectXVertexShader                   VS_Standard;
    public VaDirectXPixelShader                    PS_Forward;
    public VaDirectXPixelShader                    PS_Deferred;
}
