...
//        consts.FogDummy1                            = 0.0f;
    ...
    public final void SetDirectionalLightDirection( float x, float y, float z )                         { m_directionalLightDirection.set(x,y,z); }
    public final void SetDirectionalLightDirection(  ReadableVector3f newValue )                         { m_directionalLightDirection.set(newValue); }
    public final void SetDirectionalLightIntensity(  ReadableVector3f newValue )                         { m_directionalLightIntensity.set(newValue); }
    public final void SetAmbientLightIntensity( ReadableVector3f newValue )                              { m_ambientLightIntensity    .set(newValue); }
