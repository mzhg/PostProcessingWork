...
public class VaDirectXVertexBuffer extends VaDirectXBuffer  {
    protected VaDirectXVertexBuffer(int elementSize) {
        super(elementSize);
    }

    void Create(int elementCount, Object initializeData /*= NULL*/, int usage /*= D3D11_USAGE_DEFAULT, uint32 cpuAccessFlags = 0*/ ){
        Create( elementCount, /*D3D11_BIND_VERTEX_BUFFER*/ GLenum.GL_ARRAY_BUFFER, initializeData, usage/*, cpuAccessFlags*/ );
    }

    void Create( int elementCount, int usage /*= D3D11_USAGE_DEFAULT, uint32 cpuAccessFlags = 0*/ ){
        Create( elementCount, /*D3D11_BIND_VERTEX_BUFFER*/GLenum.GL_ARRAY_BUFFER, null, usage/*, cpuAccessFlags*/ );
    }
    void Create(int elementCount, BufferGL resource, int usage /*= D3D11_USAGE_DEFAULT, uint32 cpuAccessFlags = 0*/ ){
        Create( elementCount, resource, true, /*D3D11_BIND_VERTEX_BUFFER*/GLenum.GL_ARRAY_BUFFER, usage/*, cpuAccessFlags*/ );
    }
