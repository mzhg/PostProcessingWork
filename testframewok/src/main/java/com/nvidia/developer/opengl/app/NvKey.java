 ...
 * <p>
 * This is currently designed around us keyboard mappings for simplicity, and
 * quoted ASCII literals for values where appropriate.
 * <p>
 * This could easily be changed to use codes from say the USB HID usage table
 * for keyboard scan codes.
 * <p>
 * Other design note is I've tried to keep keycodes in the lower 16-bits, and
 * bit flags in the upper 16. So if you mask out the high 16, you'll get
 * non-unique modifiers, AND we can pass mod+key into functions that don't
 * accept modifiers as bindable keys.
 * 
 * @author Nvidia 2014-9-12 22:54
 * 
 */
public interface NvKey {

    public static final int K_UNKNOWN = 0x80000000, ///< high bit + zero flags unknown value.
